import { faCar, faCreditCard, faHeadset, faHeart, faHeartCircleBolt, faHeartCircleCheck, faL, faPlus, faPlusCircle, faShield, faShieldHalved, faShieldVirus, faStar } from '@fortawesome/free-solid-svg-icons';
...
export const ratingStarsArray = []

    for (let i = 0; i < 5; i++) {
        ratingStarsArray.push(<FontAwesomeIcon icon={faStar} style={{ color: "d4d431" }} key={i} />)
    }
...
export const restCarousels = SliderData.filter((val, index) => index !== 0)
// console.log(restCarousels)

export const serviceData = [
    {
        icon: <FontAwesomeIcon icon={faCar} />,
        title: "Free Shipping",
        subtitle: "Shipping in 24 Hours",
        bg: "#fdefe6",
    },
    {
    ...
    },
    {
        ...
        subtitle: "24/7 Online Customer Care",
        bg: "#d6e5fb",
    },
];
